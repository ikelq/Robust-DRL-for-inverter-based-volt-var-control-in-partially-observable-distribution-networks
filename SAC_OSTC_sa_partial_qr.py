...
class ReplayBuffer:
    ...
    def store_1(self,
                rew: float):
        self.rews_buf[self.ptr-15:self.ptr-1, :] = rew
...
class SACAgent:
    ...
    def train(self, num_frames: int, plotting_interval: int = 400):
        ...
        for self.total_step in range(1, num_frames + 1):
            ...
            # reward_4 += reward
            # if self.env.step_n % 15 == 0:
            #     self.memory.store_1(reward_4/15)
            #     reward_4 = 0
        ...
        data_train.to_csv('trainsac' + str(self.env.name) + str(self.seed) + str(self.partical) + 'tootsaqr.csv')
        ...
        data_train_test.to_csv('traintestsac' + str(self.env.name) + str(self.seed) + str(self.partical) + 'tootsaqr.csv')
        ...
        data_train_loss.to_csv('trainlosssac' + str(self.env.name) + str(self.seed) + str(self.partical) + 'tootsaqr.csv')
        #
