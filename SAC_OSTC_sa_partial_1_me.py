...
class ReplayBuffer:
    ...
    def store(
        ...
        self.obs_buf[self.ptr:self.ptr+decay_average] = obs
        self.next_obs_buf[self.ptr:self.ptr+decay_average] = next_obs
        self.acts_buf[self.ptr:self.ptr+decay_average] = act
        self.rews_buf[self.ptr:self.ptr+decay_average] = rew
        self.done_buf[self.ptr:self.ptr+decay_average] = done
        self.ptr = (self.ptr + decay_average) % self.max_size
        self.size = min(self.size + decay_average, self.max_size)
...
class SACAgent:
    ...
    def train(self, num_frames: int, plotting_interval: int = 400):
        ...
        data_train.to_csv('trainsac' + str(self.env.name) + str(self.seed) + str(self.partical) + 'tootsa'+str(qr)+str(decay)+str(decay_average)+'l1me.csv')
        ...
        data_train_test.to_csv('traintestsac' + str(self.env.name) + str(self.seed) + str(self.partical) + 'tootsa'+str(qr)+str(decay)+str(decay_average)+'l1me.csv')
        ...
        data_train_loss.to_csv('trainlosssac' + str(self.env.name) + str(self.seed) + str(self.partical) + 'tootsa'+str(qr)+str(decay)+str(decay_average)+'l1me.csv')
        #
