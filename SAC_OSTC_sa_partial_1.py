...
if __name__ == "__main__":
    ...
    parser.add_argument("--partial", default=26, type=int) 
    ...
    if partial == 25:
        import Env_partial_state_reward_li_np_topology_change as Env
    
    if partial == 26:
        import Env_partial_state_voltage_without_load_topology as Env
