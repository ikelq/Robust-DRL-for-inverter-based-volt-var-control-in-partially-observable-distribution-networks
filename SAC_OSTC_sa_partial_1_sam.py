...
class ReplayBuffer:
    ...
    def store_1(self,
                rew: float):
        self.rews_buf[self.ptr-decay_average_reward:self.ptr-1, :] = rew
...
class SACAgent:
    ...
    def train(self, num_frames: int, plotting_interval: int = 400):
        ...
        for self.total_step in range(1, num_frames + 1):
            ...
            if decay_average_reward != 0:
                reward_5 += reward
                if self.env.step_n % decay_average_reward == 0:
                    self.memory.store_1(reward_5/decay_average_reward)
                    reward_5 = 0
        ...
        data_train.to_csv('trainsac' + str(self.env.name) + str(self.seed) + str(self.partical) + 'tootsa'+str(qr)+str(decay)+str(decay_average_reward)+'sam.csv')
        ...
        data_train_test.to_csv('traintestsac' + str(self.env.name) + str(self.seed) + str(self.partical) + 'tootsa'+str(qr)+str(decay)+str(decay_average_reward)+'sam.csv')
        ...
        data_train_loss.to_csv('trainlosssac' + str(self.env.name) + str(self.seed) + str(self.partical) + 'tootsa'+str(qr)+str(decay)+str(decay_average_reward)+'sam.csv')
        #
...
if __name__ == "__main__":
    ...
    decay_average_reward = 15   # eahc dacay_average_reward data have the same reward
