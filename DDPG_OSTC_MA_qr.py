...
class DPGAgent:
    ...
    def train(self, num_frames: int, plotting_interval: int = 400):
        ...
        data_train.to_csv('train' + str(self.env.name) + str(self.seed) + 'twomulti'+'local'+str(self.is_local)+'qr.csv')
        ...
        data_train_test.to_csv('traintest' + str(self.env.name) + str(self.seed) + 'twomulti'+'local'+str(self.is_local)+'qr.csv')
        ...
        data_train_loss.to_csv('trainloss' + str(self.env.name) + str(self.seed) + 'twomulti'+'local'+str(self.is_local)+'qr.csv')
